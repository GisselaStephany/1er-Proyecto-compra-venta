 ...
 function cargarCarrito(){
    ...
    for (let i= 0; i < carrito.length; i++){
        cadena += ` <tr>
                        ...
                        <td>
                            <input type="number" onkeyup="cambiaCantidad(${i},this)" onchange="cambiaCantidad(${i},this)" value="${carrito[i].cantidad}" class="form" placeholder="Cantidad">
                        </td>
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            for (let i = 0; i < laCompra.detalles.length; i++) {
                for (let j = 0; j < losProductos.length; j++) {
                    if (losProductos[j].nomProducto ==laCompra.detalles[i].producto) {
            ...
            Swal.fire({
                title: "Eliminada!",
                text: "Tu compra ha sido eliminada.",
                icon: "success",
            });
        }
    });
