...
function registrarCliente(){
    ...
    if(nombre == '' || apellidos == '' || documento == '' || tipoDocumento == '' || telefono == '' || correo == ''){
        Swal.fire({
            title: "Faltan datos!",
...
function cargarDatos(){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        cadena += ` <tr>
                        ...
                        <td>${clientes[i].tipoDocumento}</td>
...
function setearDatos(){
    ...
    document.getElementById('tipoDoc').value = elCliente.tipoDocumento;
